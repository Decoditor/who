                ...
                <div className="relative hidden overflow-hidden bg-primary text-primary-foreground lg:block">
                    ...
                    <div className="relative flex min-h-[calc(100svh-10rem)] items-center justify-center px-10">
                        <div className="relative w-full max-w-2xl">
                            ...
                            {/* Central endorsement card */}
                            <div className="relative mx-auto max-w-md rotate-[-2deg] bg-background p-6 text-foreground shadow-2xl transition-transform duration-500 hover:rotate-0">
                            ...
                            {/* Floating label */}
                            <div className="absolute -bottom-8 -right-3 flex items-center gap-2 rounded-full bg-lime px-4 py-2 text-xs font-bold text-accent-foreground shadow-lg">
                    ...
                    <div className="flex flex-1 items-center px-5 py-10 sm:px-10 lg:px-16 xl:px-20">
                        <div className="mx-auto w-full max-w-lg">
                            <div className="mb-10">
                                ...
                                <h1 className="text-4xl font-black leading-none tracking-tighter sm:text-5xl">
                                    {title}
                                </h1>
